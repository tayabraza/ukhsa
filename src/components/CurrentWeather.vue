<template>
    <div v-if="weather?.location && weather?.current" class="weather-card" :class="[Number(weather.location.localtime.slice(10,13)) > 6 && Number(weather.location.localtime.slice(10,12)) < 20 ? 'day' : 'night']">
